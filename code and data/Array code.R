...
d <- as.double((as.character(t_array50[2,5])))
d
d*d
t_array50[2,5]*t_array50[2,5]
...
sum(t_array50$ACTR3B [496:498])
mutate(t_array50, plus = t_array50$ACTR3B * 2)
as.numeric((as.character(t_array50$ACTR3B[496:498] * 2)))
