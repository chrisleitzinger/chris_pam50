...
actine_reported_expression$Patient_ID <- substr(actine_reported_expression$Patient_ID,start = 6,stop = 12)
...
# merge 
dfpatient_A50 <- merge.data.frame(Dat_Patient_Calls, actine_reported_expression
                        , by.x = "PATIENT_ID", by.y = "Patient_ID", all.x=TRUE, all.y = TRUE)
